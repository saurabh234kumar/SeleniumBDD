...
import org.openqa.selenium.devtools.v114.layertree.model.Layer;
...
public abstract class WebUtils {
	...
	protected static java.util.logging.Logger testLogger;
	private Wait<WebDriver> wait;

	public WebUtils(WebDriver driver) {
		this.driver = driver;
		ajaxWait = new WebDriverWait(driver, TIME_OUT);
		testLogger = java.util.logging.Logger.getLogger(org.slf4j.Logger.class.getName());
	}
